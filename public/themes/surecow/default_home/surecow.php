				...
				<div class="top-header">
					<div class="container">
						<a href="index.html" id="branding">
							<img src="<?= BASE_URL?>/images/logo.png" alt="Company Name" class="logo">
							<div class="logo-text">
						...
						<div class="right-section pull-right">
							<a href="#" class="phone"><img src="<?=BASE_URL?>/images/icon-phone.png" class="icon">+1 823 424 9134</a>
					
							<form action="#" class="search-form">
								<input type="text" placeholder="Search...">
								<button type="submit"><img src="<?= BASE_URL?>/images/icon-search.png" alt=""></button>
							</form>
						</div>
					</div> <!-- .container -->
				</div> <!-- .top-header -->
					...
					<div class="container">
						...
						<div class="main-navigation">
							...
							<ul class="menu">
								...
								<li class="menu-item"><a href="app/login" 
								 class="btn btn-primary btn-small">login</a></li>
								<li class="menu-item"><button type="button"
								 class="btn btn-primary btn-small btn-warning">
									Register</button>
							</li>
							</ul> <!-- .menu -->
						</div>
